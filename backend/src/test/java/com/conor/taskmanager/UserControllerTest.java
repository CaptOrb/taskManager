...
public class UserControllerTest {
        ...
        // Test Bean Validation for registration
        @Test
        ...
        public void register_whenUsernameIsEmpty_returnsBadRequest() throws Exception {
                mockMvc.perform(post("/api/auth/register")
                                ...
                                .andExpect(jsonPath("$.errors.userName", anyOf(
                                                is("Username is required"),
                                                is("Username must be between 3 and 32 characters"))));
        }
        ...
        @Test
        public void register_whenEmailIsInvalid_returnsBadRequest() throws Exception {
                mockMvc.perform(post("/api/auth/register")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"userName\":\"testUser\",\"email\":\"invalid-email\",\"password\":\"password123\",\"passwordConfirm\":\"password123\"}"))
                                .andDo(print())
                                .andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.message").value("Validation failed"))
        ...
        public void register_whenPasswordIsTooShort_returnsBadRequest() throws Exception {
                mockMvc.perform(post("/api/auth/register")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"userName\":\"testUser\",\"email\":\"testUser@example.com\",\"password\":\"123\",\"passwordConfirm\":\"123\"}"))
                                .andDo(print())
                                .andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.message").value("Validation failed"))
                                .andExpect(jsonPath("$.errors.password")
                                                .value("Password must be between 6 and 64 characters"));
        }
        ...
        public void register_whenUsernameIsTaken_returnsBadRequest() throws Exception {
                ...
                mockMvc.perform(post("/api/auth/register")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(
                                                "{\"userName\":\"existingUser\",\"email\":\"newUser@example.com\",\"password\":\"password123\",\"passwordConfirm\":\"password123\"}"))
                                .andDo(print())
                                .andExpect(status().isBadRequest())
        ...
        public void register_whenEmailIsTaken_returnsBadRequest() throws Exception {
                ...
                mockMvc.perform(post("/api/auth/register")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(
                                                "{\"userName\":\"newUser\",\"email\":\"existingUser@example.com\",\"password\":\"password123\",\"passwordConfirm\":\"password123\"}"))
                                .andDo(print())
                                .andExpect(status().isBadRequest())
                                .andExpect(content().string("Email is already taken."));
        }

        // Test Bean Validation for login
        @Test
        ...
        @Test
        public void login_whenUsernameIsEmpty_returnsBadRequest() throws Exception {
                mockMvc.perform(post("/api/auth/login")
                                .contentType(MediaType.APPLICATION_JSON)
        ...
        @Test
        public void login_whenPasswordIsEmpty_returnsBadRequest() throws Exception {
                mockMvc.perform(post("/api/auth/login")
                                .contentType(MediaType.APPLICATION_JSON)
        ...
        @Test
        @WithMockUser(username = "test@example.com")
        public void changePassword_whenCurrentPasswordEmpty_returnsBadRequest() throws Exception {
                mockMvc.perform(post("/api/auth/change-password")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"currentPassword\":\"\",\"newPassword\":\"newPassword123\",\"confirmPassword\":\"newPassword123\"}"))
                                .andDo(print())
                                .andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.message").value("Validation failed"))
                                .andExpect(jsonPath("$.errors.currentPassword").value("Current password is required"));
        }

        @Test
        @WithMockUser(username = "test@example.com")
        public void changePassword_whenNewPasswordEmpty_returnsBadRequest() throws Exception {
                mockMvc.perform(post("/api/auth/change-password")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"currentPassword\":\"oldPassword\",\"newPassword\":\"\",\"confirmPassword\":\"newPassword123\"}"))
                                .andDo(print())
                                .andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.message").value("Validation failed"))
                                .andExpect(jsonPath("$.errors.newPassword", anyOf(
                                                is("New password is required"),
                                                is("New password must be between 6 and 64 characters"))));
        }
        ...
        public void changePassword_whenNewPasswordTooShort_returnsBadRequest() throws Exception {
                mockMvc.perform(post("/api/auth/change-password")
                                ...
                                .andExpect(jsonPath("$.errors.newPassword")
                                                .value("New password must be between 6 and 64 characters"));
        }
